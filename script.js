...
function initSwirlBackground() {
  ...
  // Keep each wave moving at slightly different speeds to mimic layered fluid ribbons.
  gsap.to('.swirl-layer-1', {
    xPercent: 3,
    y: -10,
    rotation: 1.2,
    duration: 18,
  ...
  // Small accent shapes drift slowly to avoid a static look without clutter.
  gsap.to('.swirl-chip-1', {
    x: 18,
    y: -12,
    rotation: 8,
    duration: 14,
